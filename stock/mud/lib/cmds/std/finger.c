...
#ifdef XXX
    write("Finger is in debug mode. No more info availible.\n");
    return "\n"+finger+NORM+"\n";
#endif
...
status main(string arg) {
    ...
    if(!arg || arg == "")
    return notify_fail("playerinfo:  Syntax:  pi <user>[@<mud>]\n"),0;
