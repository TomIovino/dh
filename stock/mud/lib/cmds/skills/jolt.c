...
status main(string targ, mixed alt_type, mixed spell_type){
	...
	"level",  30,
	"cast time", 1,
	"msg target", COLOR+desc+" "+ELEMENT+" jolt springs from "+NAME
	+ "'s hand, striking you!\n"+NORM,
	"msg room", COLOR+desc+" "+ELEMENT+" jolt springs from "+ NAME
	+ "'s hand, striking "  +TARG+ "!\n"+NORM,
	"msg caster", COLOR+desc+" "+ELEMENT+" jolt springs from your hand " 
	+ "striking "+ TARG + NORM +"!\n",
      }));
    return 1;
}
