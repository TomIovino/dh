...
"been bleached white from the sun. Here, a rugged mountain rises from\n"+
"the plateau. North of here is a white walled keep which has been built\n"+
"into the mountainside.\n"+
NORM);
    set_items(({
    "mountains","High mountains rise to the northeast.\n",
    "mountain","A large mountain looms over the plateau.\n",
    "pathway","A rugged path around the mountains.\n",
    "sky#u#up","The sky is clear and the wind blows from the south.\n",
    "plateau",
    "A large flat table of land.\n",
