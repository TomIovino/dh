...
"to those who would continue up this rocky slope. Down leads to a\n"+
"rocky mountain plateau. Northeast and northwest are trails around\n"+
...
"tint to them.\n"+
   ...
   "down#d#floor#ground#tint#gravel#boulders#boulder",
     ...
     "and boulders have an orange tint from tiny flecks of amber imbedded\n"+
     "in the stone.\n",
   }));
    set_light(1);
