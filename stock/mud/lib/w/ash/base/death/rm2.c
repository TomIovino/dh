...
"to those who would continue up this rocky slope. Northeast and\n"+
"southeast are trails around the mountain peak.\n"+
   ...
   "down#d#floor#ground#gleam#gravel#boulder#boulders",
     ...
     "and boulders gleam from tiny flecks of pearl imbedded in the stone.\n",
   }));
    set_light(1);
    ...
    set_exits(({
      "/w/ash/base/"+KI+"/up",        "up",
      "/w/ash/base/"+KI+"/rm3",       "northeast",
      "/w/ash/base/"+KI+"/rm1",       "southeast",
              }));
}
