...
"shadows and movements and causing a great darkness all about.\n"+NORM);
   set_items(({
    "sky#up#down",
      "You cant see that far..\n",
    "mist",
      "The mist is thick and makes seeing past it nearly impossible.\n",
    ...
    set_exits(({
      "/w/ash/dragon/path/mist_n","away",
      "/w/ash/dragon/path/mist_s","closer",
      "/w/ash/dragon/path/mist_w","there",
      "/w/ash/dragon/path/mist_e","here",
              }));
}
