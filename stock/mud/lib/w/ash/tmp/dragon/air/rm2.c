...
void reset(status arg) {
  ...
  set_long(GREY_F+
"A huge forbidding mountain looms directly to the east. A smooth\n"+
"cliff face meets sheer mountain outcroppings, providing a challenge\n"+
"to those who would continue up this rocky slope. West leads down\n"+
"into the valley of mist. Northeast and southeast are trails around\n"+
"the mountain peak.\n"+ 
   NORM);
   set_items(({
   "sky#up#u",
   ...
   "down#d#floor#ground#tint#gravel#boulder#boulders",
    ...
    set_exits(({
      ...
      "/w/ash/dragon/"+KI+"/rm3",       "northeast",
      "/w/ash/dragon/"+KI+"/rm1",       "southeast",
      "/w/ash/dragon/"+KI+"/mist_start","west",
              }));
}
