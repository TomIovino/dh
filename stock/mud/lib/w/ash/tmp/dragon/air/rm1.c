...
"to those who would continue up this rocky slope. South leads down\n"+
"into the valley of mist. Northeast and northwest are trails around\n"+
"the mountain peak. The gravel and boulders of this area have a strange\n"+
"tint to them.\n"+
   NORM);
   set_items(({
   "sky#up#u",
   ...
   "valley#mist",
     "A deep valley filled with thick mist surrounds the mountain like a\n"+
     "moat.\n",
   "trails#trail",
   ...
   "down#d#floor#ground#tint#gravel#boulders#boulder",
     ...
     "and boulders have a yellow tint from tiny flecks of topaz imbedded\n"+
     "in the stone.\n",
   }));
    set_light(1);
    ...
    set_exits(({
      "/w/ash/dragon/"+KI+"/up",        "up",
      "/w/ash/dragon/"+KI+"/rm2",       "northwest",
      "/w/ash/dragon/"+KI+"/rm4",       "northeast",
      "/w/ash/dragon/"+KI+"/mist_start","south",
              }));
}
...
search(string what){ 
      ...
      blah = 1;
      add_object("rune","/w/ash/dragon/"+KI+"/rune"); 
