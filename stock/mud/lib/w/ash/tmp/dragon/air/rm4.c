...
"to those who would continue up this rocky slope. East leads down\n"+
"into the valley of mist. Northwest and southwest are trails around\n"+
"the mountain peak.\n"+ 
   NORM);
   set_items(({
   "sky#up#u",
   ...
   "down#d#floor#ground#tint#gravel#boulder#boulders",
    ...
    set_exits(({
      ...
      "/w/ash/dragon/"+KI+"/rm3",       "northwest",
      "/w/ash/dragon/"+KI+"/rm1",       "southwest",
      "/w/ash/dragon/"+KI+"/mist_start","east",
              }));
}
