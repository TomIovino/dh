...
"to those who would continue up this rocky slope. North leads down\n"+
"into the valley of mist. Southwest and southeast are trails around\n"+
"the mountain peak.\n"+ 
   NORM);
   set_items(({
   "sky#up#u",
   ...
   "down#d#floor#ground#tint#gravel#boulder#boulders",
    ...
    set_exits(({
      ...
      "/w/ash/dragon/"+KI+"/rm2",       "southwest",
      "/w/ash/dragon/"+KI+"/rm4",       "southeast",
      "/w/ash/dragon/"+KI+"/mist_start","north",
              }));
}
