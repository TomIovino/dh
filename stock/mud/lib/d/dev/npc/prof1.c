...
reset(arg){
    ...
    set_short(COLOR+RACE+" "+PROF1+" instructor"+NORM);
  ...
  if(query_gender() == 2){
    ...
    set_class_list(({
        "skills", ({
 "unarmed","thrust","pierce","pound","crush","slash","cleave",
 "artifact",
 "critical hit","parry","peek","sneak","hide","dodge",
 "steal","fast healing","dual wield","endurance",
        }),
      }));
