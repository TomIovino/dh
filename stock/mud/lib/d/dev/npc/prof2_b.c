...
reset(arg){
    ...
    set_short(COLOR+RACE+" "+PROF2+" master"+NORM);
  ...
  if(query_gender() == 2){
    ...
    set_class_list(({
        "skills", ({
         ...
         "spells", ({
 "bless","frenzy","curse","purify","dispel","heal",
 "refresh", "drain","weaken", "poison",
 "stun","blind","heroism","fear","wings","sight","exoskin",
 "claws","fangs","tame","absorb","deflect","sight","track",
 "reflect","invisibility","awareness","identify","enchant",
 "prayer","chant","calm","explorer","defender","avenger",
        }),
      }));
