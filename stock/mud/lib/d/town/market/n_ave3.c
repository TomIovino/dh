...
void reset(status arg) {
    ...
    set_long(RED_F+
"A cobblestone road leads south of here further into the market\n"+
"district of the city. North leads back into the city proper.\n"+
    NORM);
    set_items(({
    ...
    set_exits(({
	"d/town/road/e3","north",
	"d/town/market/ave3","south",
      }));
   set_light(5);
}
