...
"of here you can see the western gates. Towards the south of here\n"+
...
"here is a smaller wall which protects the embassy district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/wad","north",
	"d/town/road/wab","south",
   }));
...
enter(){
  ...
  r = this_player()->query_profession();
  this_player()->move_player("X#/d/town/profession/"+r);
  return 1;
}
