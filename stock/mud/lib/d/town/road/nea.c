...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the north wall completely around. Far to the\n"+
"west of here you can see the western gates. Directly east of here\n"+
...
"here is a smaller wall which protects the temple district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/neb","west",
	"d/town/road/toe1","east",
   }));
