...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the west wall completely around. Directly north\n"+
"of here you can see the western gates. Far to the south of here\n"+
...
"here is a smaller wall which protects the embassy district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/wgates","north",
	"d/town/road/wad","south",
   }));
