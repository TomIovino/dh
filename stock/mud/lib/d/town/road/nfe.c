...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the north city wall completely around. Directly to the\n"+
"east of here you can see the northern gates and to the west of here a ways\n"+
"is the large tower which is at the corner of the city walls. South of here\n"+
"is a smaller wall which protects the castle courtyard.\n"
    NORM);
    set_items(({
   ...
   set_light(5);
   set_exits(({
	"d/town/road/ngates","east",
	"d/town/road/nfd","west",
   }));
