...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This is the southeast corner of the city. A set of stairs on the\n"+
"wall lead up to a tower. North and west you can see paths that lead\n"+
"towards other parts of the city.\n"+ 
   ...
   set_light(5);
   set_exits(({
	"d/town/road/ewa","north",
	"d/town/road/swa","west",
   }));
