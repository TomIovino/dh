...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the east wall completely around. To the south\n"+
"of here you can see the eastern gates. To the north of here is\n"+
"a large tower which is at the corner of the city walls. West of\n"+
"here is a smaller wall which protects the temple district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/egates","south",
	"d/town/road/eed","north",
   }));
