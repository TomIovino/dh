...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the west wall completely around. Towards the\n"+
"south of here you can see the western gates. Towards the north of here\n"+
"is the large tower which is at the corner of the city walls. East of\n"+
"here is a smaller wall which protects the castle courtyard.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/wfc","south",
	"d/town/road/wfa","north",
   }));
