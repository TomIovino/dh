...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the east wall completely around. Towards the north\n"+
"of here you can see the eastern gates. Towards the south of here\n"+
...
"here is a smaller wall which protects the market district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/ewd","north",
	"d/town/road/ewb","south",
   }));
