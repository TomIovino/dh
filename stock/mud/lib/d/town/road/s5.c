...
void reset(status arg) {
   if(arg) return;
    set_short(ROAD_NAME);
    set_long(BROWN_F+
"Directly to the south the city gates can be seen leading into the\n"+
"great forest beyond. Northeast of here an entrance leads to the market\n"+
"courtyard. West along the road are walls that separate the embassy\n"+
"district from the rest of town.\n"+
    ...
    "market", GREEN_F"Various markets are north and east of here.\n",
    "castle",B_WHITE_F"A large castle in good repair to the northwest.\n",
   }));
   set_light(5);
   set_exits(({
	"d/town/road/sgates","south",
	"d/town/road/s4",TOWARDS,
   }));
