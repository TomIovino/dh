...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the east wall completely around. Directly north\n"+
"of here you can see the eastern gates. Far to the south of here\n"+
...
"here is a smaller wall which protects the market district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/egates","north",
	"d/town/road/ewd","south",
   }));
