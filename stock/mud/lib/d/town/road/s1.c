...
void reset(status arg) {
   if(arg) return;
    set_short(ROAD_NAME);
    set_long(BROWN_F+
"Far to the south the city gates can be seen leading into the great\n"+
"forest beyond. South and east an entrance leads to the town's main\n"+
...
"district from the rest of town.\n"+
    ...
    "market", GREEN_F"Various markets are south east of here.\n",
