...
void reset(status arg) {
   if(arg) return;
    ...
    set_long(BROWN_F+
"This path follows the east wall completely around. Far to the\n"+
"south of here you can see the eastern gates. Directly north of here\n"+
...
"here is a smaller wall which protects the temple district.\n"
   ...
   set_light(5);
   set_exits(({
	"d/town/road/eeb","south",
	"d/town/road/toe1","north",
   }));
