...
void reset(status arg) {
 ...
 if(THIS_ENV == "twilite"){
  ...
  "plateau. Ahead is a gate from which you may try to enter the city.\n"+
 ...
 if(THIS_ENV != "twilite"){
  ...
  "the natural defenses of the area. You see a well fortified gate ahead.\n"+
  "A sign written in common is posted to a nearby tree."+
  NORM);
  add_item("sign","All foreigners will die.\n");
