...
#define NOLEARN       loaded_spell[18]
#define SPELL_STAT    loaded_spell[19]
...
#define NOLEARN       default_spell[18]
#define SPELL_STAT    default_spell[19]

#endif /* MONSTER */

#define SPELL_ALLOCATE 20
